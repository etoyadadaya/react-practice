	...
	return (
		<form className={styles['journal-form']} onSubmit={addJournalItem}>
			<div className={styles['form-row']}>
				...
				/>
				{data?.id && <button onClick={deleteJournalItem} type="button" className={styles['delete']}>
			...
			<div className={styles['form-row']}>
				...
				<Input type='date' ref={dateRef} onChange={onChange} name='date'
					value={values.date ? new Date(values.date).toISOString().slice(0, 10) : ''} id="date"
